...
\begin{figure}
\includegraphics[width=300pt]{C:/Users/Andy/Desktop/CASA_thesis_template/general_images/example_flow} \caption{Summary of methdological procedure for (a).... and (b)....}\label{fig:methodsflow}
\end{figure}
