...
1. Go to the `_output.yml` file and change the `edit` argument to `YOURREPO/edit/master/%s`, here it's `https://github.com/andrewmaclachlan/CASA-MSc-thesis/edit/master/%s`
